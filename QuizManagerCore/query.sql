...
SELECT ID,CONTENT, DIFFICULTY FROM MCQQUESTIONS WHERE CONTENT LIKE '%What%' AND DIFFICULTY <= 3;
...
SELECT ID,CONTENT, DIFFICULTY FROM MCQQUESTIONS WHERE CONTENT LIKE ? AND DIFFICULTY <= ?;  --To replace ? by a value